...
// } else {
//     return "Your'e not in our delivery zone."
// }

const canWeDeliver = (zipCode) => {
    if(deliveryAreaZipCodes.includes(zipCode)) 
    return "your'e in our delivery zone!"
    else return "your'e not in our delivery zone"
}
console.log("canWeDeliver ==>", canWeDeliver(85205))
...
console.log("canWeDeliver2 ==>" , canWeDeliver2(85205))
